...
/**
 * Description of orderboxDomains
 *
...
$config->set('debugMode', true)
       ->set('returnType', 'xml')
       ->set('tlds', array('com', 'net', 'org'));

$test = new Orderbox($config);   
echo $test->domainsAvailabilityCheck() . "\n";
echo $test->domainsAvailabilityCheckIdn() . "\n";
echo $test->domainsSuggestion() . "\n";
echo $test->registerDomains() ."\n";
